              ...
              <div className="mt-6 border-t border-slate-800 pt-6">
                <div className="bg-slate-800/50 rounded-lg border border-slate-700/50 overflow-hidden">
                  ...
                  <div className="p-3 max-h-48 overflow-y-auto space-y-2 custom-scrollbar">
                    ...
                    <div className="flex justify-between items-center text-xs p-2 hover:bg-slate-700/50 rounded transition-colors cursor-default group">
                      <div>
                        <p className="text-white font-medium group-hover:text-orange-400 transition-colors">Sales Team</p>
                        <p className="text-slate-500">sales / sales123</p>
                      </div>
                      <div className="h-2 w-2 rounded-full bg-orange-500"></div>
                    </div>
                    <div className="flex justify-between items-center text-xs p-2 hover:bg-slate-700/50 rounded transition-colors cursor-default group">
                      <div>
                        <p className="text-white font-medium group-hover:text-yellow-400 transition-colors">Fleet Driver</p>
